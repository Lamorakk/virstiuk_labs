...
//1.1.	 Побудувати у середовищі Draw.io таблично-графічну схему роботи методу сортування бульбашкою(за зростанням).
//1.2.	Побудувати у середовищі таблично-графічну схему сортування за зростанням згідно з методом вставок (представлення початку виконання + етап завершення сортування).
